<div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
    <div style="margin:50px auto;width:70%;padding:20px 0">
        <div style="border-bottom:1px solid #eee">
            <a href="" style="font-size:1.4em;color: #00466a;text-decoration:none;font-weight:600">DABS Gamification - Truffle Belly</a>
        </div>
        <p style="font-size:1.1em">Hi, {!!$fullname!!} </p>
        <p>Berikut link untuk bermain anda</p>
        <a href="https://trufflebellu.dabstech.site/update?id=%7B!!$unique_id!!%7D" target="_blank" rel="noopener noreferrer">
